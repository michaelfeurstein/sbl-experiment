...
NOTE: continue to refine code for presentation - but in essence we replicated period and carryover effects and also the treatment effect. All from the linear mixed models.
...
TODO: merge this into a nicer dataframe as one result.
