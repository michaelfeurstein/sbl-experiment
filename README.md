...
(2) Sanity check analyis steps by replicating and validating known values from similar experiment/data: [chowliu73_validation.Rmd](validation/chowliu73/chowliu73_validation.Rmd)
...
(4) Data analysis: [R Notebook](experiment_analysis.Rmd)
